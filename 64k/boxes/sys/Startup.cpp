...
//	memfile->length = 3000000;
	memfile->data = NULL;//(unsigned char *)&intromusic;
	memfile->pos = 0;
...
extern "C" {
	extern char texturefan;
	extern char texturefan2;
...
//		if( StartupFlags & STARTUP_MUSIC ) mmp_loadmodule(	(unsigned char *)&intromusic );
		...
		glaUploadGif( 1, (unsigned char *)&texturefan, 1 );
		glaUploadGif( 2, (unsigned char *)&texturefan2, 1 );
...
//		event_register(		0,		50.0f,		p_test_run,				0	);
		event_register(		0,		100.0f,		p_horboll_run,			0	);
