...
/*
	...
	glVertex3f( 0, 0, -300 );
	glVertex3f( 0, 0, -300 );
	glVertex3f( a.x, a.y, -300 );
	glVertex3f( b.x, b.y, -300 );
...
/*
	...
	glTexCoord2f( 0, 0 ); glVertex3f( -r, -r, 300 );
	glTexCoord2f( 1, 0 ); glVertex3f(  r, -r, 300 );
	glTexCoord2f( 1, 1 ); glVertex3f(  r,  r, 300 );
	glTexCoord2f( 0, 1 ); glVertex3f( -r,  r, 300 );
